        ...
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <JetFormSection @submitted="addTeamMember">
                ...
                <template #description>
                    Добавьте нового члена группы в свою группу, разрешив ему сотрудничать с вами.
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Пожалуйста, укажите адрес электронной почты человека, которого вы хотите добавить в эту группу.
                        </div>
                    </div>
