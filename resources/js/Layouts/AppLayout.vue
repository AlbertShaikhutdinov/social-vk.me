...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 bg-moskva-siti">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('searchVK')" :active="route().current('searchVK')">
                                    Поиск постов ВКонтакте
                                </JetNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('searchVK')" :active="route().current('searchVK')">
                            Поиск постов ВКонтакте
                        </JetResponsiveNavLink>
                    </div>
